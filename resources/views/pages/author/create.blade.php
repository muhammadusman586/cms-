<x-layout.app>
    ...
    <form class="bg-white rounded-lg shadow-sm p-8" method="POST" action="/author" enctype="multipart/form-data" >
      ...
      <div class="mb-6  pt-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input type="text" id="name" name="name" placeholder="Enter author name" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500">
          </div>
