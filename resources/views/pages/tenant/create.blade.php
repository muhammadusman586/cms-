<x-layout.app>
    <section class="py-16 px-4 max-w-4xl mx-auto">
        <form class="bg-white rounded-lg shadow-sm p-8" method="POST" action="/tenant" enctype="multipart/form-data">
            @csrf
            <!-- Tenant Name -->
            <div class="mb-6">
                <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Tenant</label>
                <input type="text" id="name" name="name" placeholder="Enter tenant name"
            ...
            <div class="mb-6">
                ...
                <input type="email" id="email" name="email" placeholder="Enter tenant email"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500">
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="password" id="password" name="password" placeholder="Enter tenant Password"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500">
            </div>
